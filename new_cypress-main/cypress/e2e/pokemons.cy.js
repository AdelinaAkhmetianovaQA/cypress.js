...
describe('Покупка фото', function () {
  ...
  it('Покупка нового аватара для тренера', function () {
       ...
       cy.get(':nth-child(1) > .auth__input').type('adelinaufa19@gmail.com');
       cy.get('#password').type('52530479Aa');
       ...
       cy.get('.pay__input-box-last-of > .pay_base-input-v2').type('Adelina Akhmetianova');
